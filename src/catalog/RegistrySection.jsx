  ...
  return (
    <React.Fragment>
      <OuterContainer style={{ marginTop : '10vh', marginBottom : '5vh' }}>
        ...
        <SocialMediaBox>
          <p style={{ color : 'gray', marginRight : '10vw' }}>SHARE:</p>
          <IconContainer>
            <FaFacebookSquare style={{ width : '100%', height : 'auto' }} />
          </IconContainer>
          <IconContainer>
            <FaTwitterSquare style={{ width : '100%', height : 'auto' }} />
          </IconContainer>
          <IconContainer>
            <FaPinterestSquare style={{ width : '100%', height : 'auto' }} />
          </IconContainer>
          <IconContainer>
            <FaEnvelope style={{ width : '100%', height : 'auto' }} />
          </IconContainer>
        </SocialMediaBox>
      </OuterContainer>
    </React.Fragment>
